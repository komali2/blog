...
* [Alternative Paths]({{< relref "#alternate-paths" >}}) - Possible alternative methods for becoming an engineer
...
English in Taiwan. For the entire year of 2015 I was in Houston working as an engineering recruiter.
...
and a Java programming class in Highschool that I probably cheated my way through.
...
My roommate could work from home whenever. He made 3x what I did and basically spent 2 hours a day
tweaking some spreadsheets, then the rest of his day playing Counter Strike. A friend of mine
...
When I got laid off from the recruiting job (oil prices had dropped from 100 to 40$ a barrel), I
...
programming bootcamps. I had also applied to, and had gotten into, a Master's in CS
...
Step 1 for me was taking the Introduction to CS50x course at Harvard through EDX. I'd link to
it, but it changes every semester, so just google it if you want to try it. I'd do videos
...
I used to build out my self study curriculum.
...
I would get extremely confused and tripped up by callbacks, I simply wasn't used to /
...
my first few questions. Lo and behold, though, I got tripped up and kind
of stuck on reduce, despite implementing it from scratch probably a hundred
times after failing the first time through. I think I was also given
...
that'd take me to Mission and 5th street downtown. I took the bus cause I could get a 70$
...
At the bootcamp itself, I'd like to get in early to get some bonus study time in, plus,
they offered a free breakfast, and first in got the best choices for the bagels. Then,
we'd start the day off with some kind generic programming problem,
similar to what you mind find on Project Euler or any of the programming challenge websites.
...
though students with cash didn't have a hard time finding good food in the area - we were at Mission
and 5th. If it was a 2 hour lunch day, I'd jog over to the 24 Hour Fitness to get a quick lift in
...
Even still, I almost never went back and read through my notes, it was almost
...
program in University. So, it was important to grab every advantage I could.
...
a teacher. On reflection, I think this was critical to me "getting" some concepts.
